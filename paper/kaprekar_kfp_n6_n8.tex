...
replaced at $n=8$ by a parity-blind $3\mid b$ family. A ground-truth
scan for $n=10$ shows the same parity-blind $3\mid b$ family recurring
and leaves the general-$n$ law open.
\end{abstract}
...
A ground-truth scan of all bases $b\le 45$ (ancillary file
\texttt{check\_n10.py}) fixes the qualitative picture and corrects a
tempting guess. Of the five channels ($5B,\dots,9B$) only $t=0$ and
$t=1$ carry infinite families, while $t=2,3$ collapse to $b=2$. The
distinguished $t=1$ family is
\[
b\equiv 0 \pmod 3,\qquad
d=\Bigl(\tfrac{2B+2}{3},\,\tfrac{2B+2}{3},\,\tfrac{B+1}{3},\,
\tfrac{B+1}{3},\,0\Bigr),
\]
of divisor $3$ --- \emph{not} the value $h-1=4$ that the $n=6,8$
divisors $(2,3)$ might suggest. There is thus no return of an even-base
advantage; $3\mid b$ persists, parity-blind, as at $n=8$. The $t=0$
families extend those of Table~\ref{tab:n8} structurally: for example
$b\equiv 10\pmod{15}$ recurs as
$d=\bigl(\tfrac{3B+3}{5},\tfrac{B}{3},\tfrac{B}{3},\tfrac{B}{3},
\tfrac{B+1}{5}\bigr)$, the $n=8$ family of the same congruence with one
additional $\tfrac{B}{3}$ entry, and the $t=0$ moduli remain odd.
\end{remark}
